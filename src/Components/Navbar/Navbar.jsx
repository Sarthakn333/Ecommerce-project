    ...
    <div className=" bg-white sticky top-0 z-50">
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              ...
              >
                ...
                <div className="border-t border-gray-200 px-4 py-6 cursor-default -ml-8" >
      ...
      <header className="relative bg-white">
        ...
        >
          ...
          Welcome to the Indian Festival Sale!
        </p>
          ...
          <div className="">
            <div className="flex h-16 items-center">
                  ...
                  <div className="flex ">
                    <h1
                      className={`text-2xl font-bold px-2 py-1 rounded ${
                        mode === "dark" ? "text-white" : "text-pink-600"
                      }`}
                    >
                      ShopEase
                    </h1>
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:ml-8 lg:flex cursor-default">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  ...
                  //    className="ml-2 text-sm font-medium text-gray-700 group-"
                      className={`ml-2 text-sm font-bold text-gray-700 group-  ${
                        mode === "dark" ? "text-white" : "text-pink-600"
                      }`}
                      style={{ color: mode === "dark" ? "white" : "" }}
                    >
