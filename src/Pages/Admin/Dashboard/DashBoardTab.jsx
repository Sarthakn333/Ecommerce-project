...
function DashboardTab() {
  ...
  console.log(order,'from dashboradtab');
  ...
  const userEmail = admin?.user?.email; // Optional chaining to avoid errors if admin or user is undefined

  const isEmailValid = userEmail === 'sarthakn333@gmail.com';
  return (
    <div>
          ...
          <Tabs defaultIndex={0} className=" ">
            ...
            <TabPanel>
              <div className="  px-4 md:px-0 mb-16">
                ...
                >
                  Product Details (only for owner)
                </h1>
                  ...
                  Order Details
                    ...
                    >
                      ...
                      allorder.cartItems.map((item, index) => {
                        const { title, category, imageUrl, price, id } = item;
                        return (
                          <tbody key={index}>
                            <tr
                              className="bg-gray-50 border-b  dark:border-gray-700"
                            ...
                            >
                              ...
                              <td
                                className="px-6 py-4 text-black "
                                style={{
                                  color: mode === "dark" ? "white" : "",  minWidth: "200px",
                                }}
                              >
