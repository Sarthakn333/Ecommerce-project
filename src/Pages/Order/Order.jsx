...
function Order() {
  ...
  console.log(order.length,'from order')
  return (
    <Layout>
      {loading && <Loader />}
      {order.length > 0 ?
        ...
        :
        (
          <h2 className="text-center text-2xl font-semibold flex items-center justify-center h-44 text-pink-600">You haven&apos;t ordered anything yet!</h2>
        )
